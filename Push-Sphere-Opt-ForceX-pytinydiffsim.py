...
def grad_finite(force_x, steps = 300, eps = ds.fraction(1,10000)):
...
'''
mass_sphere = 2.0
target = ds.Vector3(-5, 0, 0)
radius = ds.fraction(1, 2)
'''
init_force_x = 0
steps = 300

learning_rate = ds.fraction(100,1)#ds.fraction(200,1)
Max_N_interactions = 500
# =======================================================
# =======================================================
# =======================================================
